...
void loop() {
    ///doar daca primesc comanda pe serial fac poza si trimit inapoi.
    if (Serial.available() > 0) {
        ...
        // Image is stored in 'fb->buf' with a size of 'fb->len' bytes. You can now use the image data in your application.
        ...
        Serial.write(((cim.len+1) & 0xFF000000) >> 24);
        Serial.write(((cim.len+1) & 0x00FF0000) >> 16);
        Serial.write(((cim.len+1) & 0x0000FF00) >> 8);
        Serial.write(((cim.len+1) & 0x000000FF));
