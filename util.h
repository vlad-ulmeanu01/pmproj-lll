...
#define DISP_THRESH 105
#define SIGMOID_COEF 0.00390625f

#define START_PICS for (int _ = 0; _ < 32; _++) Serial.write(0);
...
namespace util {
    ...
    static float coef_corector_lookup[9] = {0.501f, 0.5039f, 0.5156f, 0.5622f, 0.7311f, 0.982f, 1.0f, 1.0f, 1.0f};
    //static float coef_corector_lookup[9] = {0.5005f, 0.502f, 0.5078f, 0.5312f, 0.6225f, 0.8808f, 0.9997f, 1.0f, 1.0f};
}
